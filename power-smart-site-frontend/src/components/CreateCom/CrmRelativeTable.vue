  ...
  methods: {
    ...
    getDefaultField() {
      if (this.crmType === 'leads') {
        ...
        return [
          { field: 'invoiceApplyNumber', formType: 'text', name: '发票申请编号' },
          { field: 'customerName', formType: 'text', name: '客户名称' },
          { field: 'contractNum', formType: 'text', name: '合同编号' },
          { field: 'contractMoney', formType: 'text', name: '合同金额' },
          { field: 'invoiceMoney', formType: 'text', name: '开票金额（元）' },
          { field: 'invoiceNumber', formType: 'text', name: '发票号码' },
          { field: 'invoiceDate', formType: 'text', name: '开票日期' }
        ]
      }
    },
    /** 获取列表数据 */
