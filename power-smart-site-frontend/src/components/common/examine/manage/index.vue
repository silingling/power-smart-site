    ...
    <div class="main-body">
      <div class="main-table-header">
        <el-button
          ...
          type="primary"
          icon="el-icon-plus"
          @click="addExamine">新建审批</el-button>
      </div>
      <el-table
        v-loading="loading"
        id="examine-table"
...
export default {
  ...
  data() {
    return {
      ...
      // 创建的相关信息
      createHandleInfo: { action: 'save', type: 'workflow', id: '' },
      // 详情展示
      showDetail: false,
      detailData: {},
  ...
  methods: {
    getBType(){
      this.adminGetBTypeAPI().then(res => {
     ...
     */
    addExamine() {
      this.createHandleInfo = { action: 'save', type: 'workflow', id: '' }
