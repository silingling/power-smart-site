...
import { examineRecordRecordListAPI } from '../../api' // 审批步骤

import Nzhcn from 'nzh/cn'
import ExamineHandle from '../../components/ExamineHandle' // 审批操作理由
import CheckFlow from '../../components/CheckFlow' // 审批流程
import CheckStatusMixin from '@/mixins/CheckStatusMixin'

// 审核信息 config 1 固定 0 自选
export default {
  name: 'ExamineInfo', // 审核操作
  components: {
    ExamineHandle,
    CheckFlow
  },
