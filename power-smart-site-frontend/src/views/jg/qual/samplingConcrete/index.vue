    ...
    <div class="main-body">
      <el-form v-show="showSearch" ref="queryForm" :model="queryParams" :inline="true" label-width="100px" style="padding-top: 20px;padding-left:10px;">
        ...
        <el-form-item label="样品名称" prop="samplesName">
          <el-input
            v-model="queryParams.samplesName"
            placeholder="请输入取样人"
            clearable
            size="small"
      ...
      <el-table v-loading="loading" :data="dataList" :height="tableHeight" @sort-change="sortChange">
        ...
        <el-table-column label="样品编号" align="center" prop="samplesNumber" show-overflow-tooltip sortable="custom"/>
        <el-table-column label="样品名称" align="center" prop="samplesName" show-overflow-tooltip sortable="custom"/>
        <el-table-column label="工程部位" align="center" prop="engineeringPart" show-overflow-tooltip sortable="custom"/>
        <el-table-column label="见证单位" align="center" prop="witnessUnit" show-overflow-tooltip sortable="custom"/>
        <el-table-column label="取样地点" align="center" prop="samplingSite" show-overflow-tooltip sortable="custom"/>
      ...
      <el-dialog :title="title" :visible.sync="open" width="900px" append-to-body>
        <el-form ref="form" :disabled="isDetails" :model="form" :rules="rules" label-width="100px" class="add-form">
          <el-row>
            ...
            <el-col :span="12">
              <el-form-item label="工程部位" prop="engineeringPart" class="add-form-input">
                <el-input v-model="form.engineeringPart" placeholder="请输入" />
              </el-form-item>
            </el-col>
			<el-col :span="12">
			  <el-form-item label="收样日期" prop="samplingDate" class="add-form-input">
			    <el-date-picker
            ...
            <el-col :span="12">
              <el-form-item label="样品编号" prop="samplesNumber" class="add-form-input">
                <el-input v-model="form.samplesNumber" placeholder="请输入" />
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="样品名称" prop="samplesName" class="add-form-input">
                <el-input v-model="form.samplesName" placeholder="请输入" />
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="样品数量" prop="number" class="add-form-input">
                <el-input v-model.number="form.number" type="number" placeholder="请输入" />
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="样品描述" prop="description" class="add-form-input">
                <el-input v-model="form.description" placeholder="请输入" />
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="检验日期" prop="checkDate" class="add-form-input">
                <el-date-picker
            ...
            <el-col :span="12">
              <el-form-item label="取样地点" prop="samplingSite" class="add-form-input">
                <el-input v-model="form.samplingSite" placeholder="请输入" />
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="检验依据" prop="cehckGist" class="add-form-input">
                <el-input v-model="form.cehckGist" placeholder="请输入" />
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="检验环境" prop="checkEnv" class="add-form-input">
                <el-input v-model="form.checkEnv" placeholder="请输入" />
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="设计强度" prop="designStrength" class="add-form-input">
                <el-input v-model="form.designStrength" placeholder="请输入" />
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="试件尺寸" prop="samplingSize" class="add-form-input">
                <el-input v-model="form.samplingSize" placeholder="请输入" />
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="生产单位" prop="productionUnit" class="add-form-input">
                <el-input v-model="form.productionUnit" placeholder="请输入" />
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="制样日期" prop="samplePreparationDate" class="add-form-input">
                <el-date-picker
                  v-model="form.samplePreparationDate"
                  type="date"
                  value-format="yyyy-MM-dd HH:mm:ss"
                  placeholder="选择日期"/>
              </el-form-item>
            ...
            <el-col :span="24">
              ...
              <el-table v-loading="loading" :data="membersList" >
                <el-table-column label="检验项目" align="center" prop="checkItem" />
                ...
                <el-table-column label="单项结论" align="center" prop="signConclusion" />
                <!-- <el-table-column label="操作" align="center" class-name="small-padding fixed-width" width="200px">
                  <template slot-scope="scope">
                    <el-button
                      size="mini"
      ...
      <el-dialog :title="titleMembers" :visible.sync="membersOpen" width="900px" append-to-body>
        <el-form ref="formMembers" :model="formMembers" :rules="rulesMembers" label-width="100px" class="add-form">
          <el-form-item label="检验项目" prop="checkItem">
            <el-input v-model="formMembers.checkItem" placeholder="请输入" />
          </el-form-item>
          <el-form-item label="单位" prop="unit">
            <el-input v-model="formMembers.unit" placeholder="请输入" />
          </el-form-item>
          <el-form-item label="性能指标" prop="performanceIndex">
            <el-input v-model="formMembers.performanceIndex" placeholder="请输入" />
          </el-form-item>
          <el-form-item label="检验结果" prop="checkResult">
            <el-input v-model="formMembers.checkResult" placeholder="请输入" />
          </el-form-item>
          <el-form-item label="单项结论" prop="signConclusion">
            <el-input type="textarea" :rows="2" v-model="formMembers.signConclusion" placeholder="请输入"></el-input>
          </el-form-item>
        </el-form>
        <div slot="footer" class="dialog-footer">
...
import {getProjectsList} from "../api/samplingConcrete";
...
export default {
  ...
  methods: {
    ...
    getList() {
      ...
      request({
        url: 'build/jgSamplingConcrete/list',
        method: 'post',
	...
	handleDetails(row) {
		...
		request({
		  url: 'build/jgSamplingConcrete/selectById/' + pipeId,
		  method: 'get'
		}).then(response => {
		  this.form = response.data
		  this.batchId = response.data.batchId
		  request({
		    url: 'build/jgSamplingConcreteProcess/selectByPId/' + response.data.batchId,
		    method: 'get'
		  }).then(response2 => {
      ...
      this.$refs['form'].validate(valid => {
        if (valid) {
          ...
          if (this.form.id != undefined) {
            request({
              url: 'build/jgSamplingConcrete/edit',
              method: 'post',
              data: this.form,
              headers: {
                'Content-Type': 'application/json;charset=UTF-8'
            ...
            request({
              url: 'build/jgSamplingConcrete/add',
              method: 'post',
              data: this.form,
              headers: {
                'Content-Type': 'application/json;charset=UTF-8'
    ...
    handleUpdateMembers(row) {
      ...
      request({
        url: 'build/jgSamplingConcreteProcess/selectById/' + pipeId,
        method: 'get'
      }).then(response => {
    ...
    submitFormMembers: function() {
      this.$refs['formMembers'].validate(valid => {
        if (valid) {
          this.formMembers.samplingConcreteId = this.batchId
          ...
          if (this.formMembers.id != undefined) {
            request({
              url: 'build/jgSamplingConcreteProcess/edit',
              method: 'post',
            ...
            request({
              url: 'build/jgSamplingConcreteProcess/add',
              method: 'post',
              data: this.formMembers,
              headers: {
                'Content-Type': 'application/json;charset=UTF-8'
