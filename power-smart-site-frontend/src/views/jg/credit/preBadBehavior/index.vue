...
<!--    <xr-header
    ...
    <div class="main-body">
      ...
      <el-table v-loading="loading" :data="dataList" :height="tableHeight" @sort-change="sortChange">
        <el-table-column label="工人姓名" align="center" prop="personnelName" width="120px" sortable="custom" />
        <el-table-column label="证件类型" :formatter="personnelCardTypeDataFc" width="120px" align="center" prop="personnelCardType" show-overflow-tooltip sortable="custom" />
        ...
        <el-table-column label="登记人姓名" align="center" prop="badDeptNpersonnel" width="120px" show-overflow-tooltip sortable="custom"/>
        <el-table-column label="登记日期" :formatter="formatterTime" align="center" prop="badDeptDate"  width="120px" show-overflow-tooltip sortable="custom"/>
        <el-table-column label="不良行为类别" :formatter="badTypeDataFc" align="center" prop="badType" width="140px"show-overflow-tooltip sortable="custom" />
        ...
        <el-table-column label="不良行为发生日期" :formatter="formatterTime" align="center" prop="badDate" width="160px" show-overflow-tooltip sortable="custom"/>
        <el-table-column label="行政区划" align="center" prop="badDivision"  width="120px" show-overflow-tooltip sortable="custom"/>
        ...
        <el-table-column label="处罚部门级别" :formatter="rewardDeptLevelDataFc" align="center" width="120px" prop="punishmentdDeptLevel" show-overflow-tooltip sortable="custom" />
        <el-table-column label="处罚依据" align="center" prop="punishmentBasis" width="200px" show-overflow-tooltip="true" sortable="custom" />
        <el-table-column label="处罚决定内容" align="center" prop="punishmentContent"  width="150px" show-overflow-tooltip sortable="custom"/>
        <el-table-column label="处罚决定文号" align="center" prop="punishmentDocument"  width="200px" show-overflow-tooltip sortable="custom"/>
        <el-table-column label="处罚日期" :formatter="formatterTime" align="center" prop="punishmentDate"  width="120px" show-overflow-tooltip sortable="custom"/>
        <el-table-column label="处罚截止日期" :formatter="formatterTime" align="center" prop="punishmentDateAsof" width="140px" show-overflow-tooltip sortable="custom"/>
          ...
          <el-row >
            ...
            <el-col :span="8">
              <el-form-item label="登记部门" prop="badDept" class="add-form-input">
                <el-input v-model="form.badDept" placeholder="请输入登记部门" />
              </el-form-item>
            </el-col>
            <el-col :span="8">
              <el-form-item label="登记人姓名" prop="badDeptNpersonnel" class="add-form-input">
                <el-input v-model="form.badDeptNpersonnel" placeholder="请输入登记人姓名" />
              </el-form-item>
            </el-col>
            <el-col :span="8">
            ...
            <el-col :span="8">
              <el-form-item label="不良行为代码" prop="badCode" class="add-form-input">
                <el-input v-model="form.badCode" placeholder="请输入不良行为代码" />
              </el-form-item>
            </el-col>
            <el-col :span="8">
              <el-form-item label="不良行为类别" prop="badType" class="add-form-input">
                <el-select
            ...
            <el-col :span="8">
              <el-form-item label="行政区划" prop="badDivision" class="add-form-input">
                <el-input v-model="form.badDivision" placeholder="请输入不良行为发生地行政区划" />
              </el-form-item>
            </el-col>
            <el-col :span="8">
            ...
            <el-col :span="8">
              <el-form-item label="处罚部门" prop="punishmentDept" class="add-form-input">
                <el-input v-model="form.punishmentDept" placeholder="请输入处罚部门" />
              </el-form-item>
            </el-col>
            <el-col :span="8">
            ...
            <el-col :span="8">
              <el-form-item label="处罚决定文号" prop="punishmentDocument" class="add-form-input">
                <el-input v-model="form.punishmentDocument" placeholder="请输入处罚决定文号" />
              </el-form-item>
            </el-col>
            <el-col :span="8">
...
export default {
  ...
  created() {
    ...
    // 不良行为类别
    this.getDicts('b_credit_bad_personnel').then(response => {
