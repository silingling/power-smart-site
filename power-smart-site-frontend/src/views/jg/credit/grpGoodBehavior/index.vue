...
<!--    <xr-header
    ...
    <div class="main-body">
      ...
      <el-table v-loading="loading" :data="dataList" :height="tableHeight" @sort-change="sortChange">
        ...
        <el-table-column label="登记部门" align="center" prop="goodDept" width="200px" show-overflow-tooltip sortable="custom"/>
        ...
        <el-table-column label="良好行为发生日期" :formatter="formatterTime" align="center" prop="goodDate" width="120px" show-overflow-tooltip sortable="custom"/>
        ...
        <el-table-column label="奖励部门" align="center" prop="rewardDept" width="200px" show-overflow-tooltip sortable="custom"/>
        <el-table-column label="奖励部门级别" :formatter="rewardDeptLevelDataFc" align="center" prop="rewardDeptLevel" sortable="custom"/>
        <el-table-column label="奖励决定内容" align="center" prop="rewardContent" width="200px" show-overflow-tooltip sortable="custom"/>
        <el-table-column label="奖励决定文号" align="center" prop="rewardDocument" width="200px" sortable="custom"/>
        <el-table-column label="奖励日期" :formatter="formatterTime" align="center" prop="rewardDate" width="120px"  sortable="custom"/>
