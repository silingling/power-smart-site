      ...
      <el-row >
        ...
        <el-col :span="24">
          <el-card class="box-card">
            <el-table v-loading="loading" @sort-change="sortChange" :data="dataList"  height="270px" @row-click="infocollectionSelect">
              <el-table-column  label="序号"  align='center' type="index"  width="60"></el-table-column>
              <el-table-column label="项目名称" :formatter="projectNameZc" sortable="custom" align="center" prop="projectId" width="160px" show-overflow-tooltip/>
              <el-table-column :formatter="attendanceSubcontractorFc" sortable="custom" label="分包单位" align="center" prop="attendanceSubcontractor" width="200px" show-overflow-tooltip />
              <el-table-column :formatter="attendanceWorkIdFc" sortable="custom" label="劳务工种" align="center" prop="attendanceWorkId" show-overflow-tooltip/>
              <el-table-column :formatter="attendanceTeamNameFc" label="班组名称" sortable="custom" align="center" prop="attendanceTeamName" show-overflow-tooltip/>
              <el-table-column label="年月" align="center" prop="attendanceMonth" sortable="custom" width="120px" show-overflow-tooltip/>
              <el-table-column label="人数" align="center" prop="infocollectionNumber" sortable="custom" width="100px" show-overflow-tooltip/>
              <el-table-column label="总出勤" align="center" prop="attendanceTotal" sortable="custom" width="100px" show-overflow-tooltip/>
              <el-table-column label="总工日" align="center" prop="manDayTotal" sortable="custom" width="100px" show-overflow-tooltip/>
                  ...
                  <el-table-column v-for="(item,indez) in riList"
                    ...
                    <template slot-scope="scope">
                      <div v-if="scope.row[item.prop] < 0" >
                        ...
                        <el-input :disabled="!isAble" size="small" v-model="scope.row[item.prop]"
                                  @input="changeInput1(scope.row[item.prop],scope.row.infocollectionId,item.label)" />
                      </div>
                      <span v-else>
                        <el-input :disabled="!isAble" v-model="scope.row[item.prop]" size="small"
                                  @input="changeInput1(scope.row[item.prop],scope.row.infocollectionId,item.label)" />
                    </span>
                    </template>
                  </el-table-column>
        ...
        if (valid) {
          request({
            ...
            if (response2.data == 1) {
              ...
              if ( response2.data == 6) {
                this.msgSuccess('班组成员无相应打卡记录，请先导入考勤打卡记录。')
              }
