...
<!--          <el-button type="primary" icon="el-icon-search" size="mini" @click="handleQuery">搜索</el-button>
      ...
      <el-table v-loading="loading" :height="tableHeight" :data="dataList" @sort-change="sortChange" >
        <el-table-column label="工作星期" align="center" prop="configurationContent" sortable="custom" />
        <el-table-column label="上班时间" align="center" prop="goWorkTime" sortable="custom" />
        <el-table-column label="下班时间" align="center" prop="afterWorkTime" sortable="custom" />
      ...
      <el-dialog :title="title" :visible.sync="open" width="1000px" append-to-body>
        <el-form ref="form" :model="form" :rules="rules" label-width="100px" class="add-form">
          <el-row>
            <el-col :span="8">
              <el-form-item label="工作星期" prop="weekData" class="add-form-input">
                <el-select
            ...
            <el-col :span="8">
              <el-form-item label="上班时间" prop="goWorkTime" class="add-form-input">
                <el-time-picker
            ...
            <el-col :span="8">
              <el-form-item label="下班时间" prop="afterWorkTime" class="add-form-input">
                <el-time-picker
...
export default {
  ...
  data() {
    return {
      ...
      rules: {
        weekData: [
          { required: true, message: '工作星期不能为空', trigger: 'blur' }
        ],
        goWorkTime: [
  ...
  methods: {
    ...
    getList() {
      ...
      this.queryParams.configurationType = '0'
    ...
    submitForm: function() {
      this.$refs['form'].validate(valid => {
        if (valid) {
          this.form.configurationType = '0'
          request({
            url: 'build/bLabourAttendanceConfiguration/validation',
            method: 'post',
            data: this.form,
            headers: {
              'Content-Type': 'application/json;charset=UTF-8'
            ...
            if (this.form.id != undefined) {
              ...
              if (responseYz.data == "1" ) {
                this.$message({
                  message: '选择的星期已存在请勿重复添加。',
                  type: 'warning'
                })
              } else {
                request({
