<template>
  <div>
    ...
    <div
      ...
      xs-empty-text="暂无权限"
      >
      <el-table  v-loading="loading" id="crm-table" :data="list" :height="tableHeight" @sort-change="sortChange" class="n-table--border"  use-virtual stripe  border highlight-current-row style="width: 100%" @row-click="handleRowClick" @selection-change="handleSelectionChange">
        ...
        <el-table-column
          ...
          show-overflow-tooltip>
            <template v-if="item.children">
              <el-table-column
                v-for="(i2,index2) in item.children"
                :key="index2"
                :prop="i2.prop"
                :label="i2.label"
                align="center"
...
<script>
  ...
  import {getList, delTrueByIds, getProjectsList} from "./speworktype";
