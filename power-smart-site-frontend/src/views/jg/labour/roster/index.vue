...
<!--          <el-form-item label="是否零工" prop="ifOddjob"  >
        ...
        <el-form-item style="float: right;margin-right: 10px!important;">
		  ...
		  v-if="canHandle('add')" @click="handleCreate">新建</el-button>
        </el-form-item>
      </el-form>
      <el-table :height="tableHeight" v-loading="loading" :data="dataList" @sort-change="sortChange">
        ...
        <el-table-column label="项目名称" :formatter="projectNameZc"  align="center" prop="projectId"  width="120px" show-overflow-tooltip sortable="custom"/>
        <el-table-column label="头像" align="center" sortable="custom" width="120px">
          <template slot-scope="scope" >
            <img    :onerror='`this.src="${require("@/assets/noimgsrc.png")}"`'    v-src="scope.row.imgCardUrl" style="height: 53px;margin-top: 6px;"/>
          </template>
        </el-table-column>
        <el-table-column label="人员姓名" align="center" prop="name" sortable="custom"  width="120px"/>
...
<!--        <el-table-column label="是否上传" align="center" prop="uploadGovernmentPlatform" width="200px" :formatter="YNSCFormat" />-->
        ...
        <el-table-column label="出生日期" align="center" prop="birthday" width="120px" sortable="custom"/>
        <el-table-column label="电话号码" align="center" prop="phone" width="120px" sortable="custom"/>
        <el-table-column label="家庭住址" align="center" prop="address" width="200px" sortable="custom"  show-overflow-tooltip/>
...
<!--        <el-table-column label="有效期止" align="center" prop="dateEnd" width="100px" />-->
        ...
        <el-table-column label="进场时间" align="center" prop="enterDate" width="120px" sortable="custom"/>

        <el-table-column label="分包单位" align="center" prop="realNameName" width="200px" sortable="custom"/>
        <el-table-column label="工人类型" align="center" prop="workRole" width="100px" :formatter="workRoleFormat" sortable="custom"/>
        ...
        <el-table-column label="计价方式" align="center" prop="valuationMethod" width="100px" :formatter="valuationMethodFormat" sortable="custom"/>
        ...
        <!--<el-table-column label="是否零工" align="center" prop="ifOddjob" width="80px" :formatter="ifOddjobFormat"/>-->
...
<!--            <el-button
      ...
      <el-dialog :title="title" :visible.sync="open" width="1200px" high="800px" append-to-body>
        <div v-if="ifOddJob == '0'">
          <infocollUpdate v-if="open" ref="updatainfo" :UID="Uid" :actionType="actionType">
         </infocollUpdate>
        </div>
        <div v-else>
        ...
        <div slot="footer" class="dialog-footer">
          <el-button v-if="action != 'details'" type="primary" @click="submitForm">确 定</el-button>
...
<script>
  ...
  import infocollUpdate from '@/views/jg/labour/roster/infocollUpdate'
  import oddJobcollUpdate from '@/views/jg/labour/roster/oddJobcollUpdate'
  ...
  export default {
    ...
    methods: {
      ...
      getList() {
		...
		//按钮操作权限
		canHandle (type) {
			return this.allAuth.roster ? this.allAuth.roster[type] : false;
      ...
      // 工人类型
      workRoleFormat(row, column){
        return this.selectDictLabel(this.workRoleOptions, row.workRole)
      },
      //技术等级  证书等级
