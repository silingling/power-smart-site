                          ...
                          <el-row>
                            ...
                            <el-col :span="8">
                                <el-form-item label="身份证号" prop="idCard" class="add-form-input">
                                  <el-input  :disabled="!isAble" v-model="form.idCard" placeholder="请输入" />
                                </el-form-item>
                            </el-col>
                            <el-col :span="8">
                                <el-form-item label="姓名" prop="name" class="add-form-input">
                                  <el-input :disabled="!isAble" v-model="form.name" placeholder="请输入" />
                                </el-form-item>
                            </el-col>
                            <el-col :span="8">
                          ...
                          <el-row>
                            ...
                            <el-col :span="8">
                              <el-form-item label="家庭住址" prop="address" class="add-form-input">
                                  <el-input  :disabled="!isAble" v-model="form.address" placeholder="请输入" />
                                </el-form-item>
                            </el-col>
                          </el-row>
                          <el-row>
                            <el-col :span="8">
                              <el-form-item label="发证机关" prop="issuingAuthority" class="add-form-input">
                                  <el-input :disabled="!isAble" v-model="form.issuingAuthority" placeholder="请输入" />
                                </el-form-item>
                            </el-col>
                            <el-col :span="8">
                          ...
                          <el-row>
							...
							<el-col :span="8">
								<el-form-item label="工龄" prop="workAge" class="add-form-input">
										<el-input v-model="form.workAge" :disabled="!isAble" placeholder="请输入" />
									</el-form-item>
							</el-col>
                          </el-row>
            ...
            <div v-show="workTypeIfspecial">
              <create-sections title="所属工种">
                <div class="infofrom">
                  ...
                  <el-input :disabled="!isAble" v-model="cerForm.cerName" placeholder="请输入" />
                  </el-form-item>
                  <el-form-item label="证书编号" prop="cerNumber" class="add-form-input">
                    <el-input :disabled="!isAble" v-model="cerForm.cerNumber" placeholder="请输入" />
                  </el-form-item>
                  ...
                  <el-form-item label="岗位名称" prop="positionTitle" class="add-form-input">
                    <el-input :disabled="!isAble" v-model="cerForm.positionTitle" placeholder="请输入" />
                  </el-form-item>
                  ...
                  <el-form-item label="发证机关" prop="cerIssuingAuthority" class="add-form-input">
                    <el-input :disabled="!isAble" v-model="cerForm.cerIssuingAuthority" placeholder="请输入" />
                  </el-form-item>
                  ...
                  <el-form-item label="证书验证" class="add-form-input">
                    <el-button :disabled="!isAble" type="primary" >点击证书验证</el-button>
                  </el-form-item>
            ...
            <create-sections title="进场信息">
              ...
              <div class="infofrom">
                ...
                <el-form-item  label="是否班组长" class="add-form-input" prop="ifTeamLeader" >
                  ...
                  <el-form-item label="每日工资" prop="dailyWage" class="add-form-input">
                    <el-input :disabled="!isAble" v-model.number="form.dailyWage" type="number" placeholder="请输入" />
                  </el-form-item>
                  ...
                  <el-form-item label="银行名称" prop="payRollBankName" class="add-form-input">
                    <el-input  :disabled="!isAble" v-model="form.payRollBankName"  placeholder="请输入" />
                  </el-form-item>
                  <el-form-item label="银行联号" prop="bankLinkNumber" class="add-form-input">
                    <el-input :disabled="!isAble" v-model="form.bankLinkNumber"  placeholder="请输入" />
                  </el-form-item>
                  <el-form-item label="银行卡号" prop="bankCardNumber" class="add-form-input">
                    <el-input  :disabled="!isAble" v-model="form.bankCardNumber"  placeholder="请输入" />
                  </el-form-item>

                  <el-form-item label="联系电话" prop="phone" class="add-form-input">
                    <el-input :disabled="!isAble" v-model="form.phone"  placeholder="请输入" />
                  </el-form-item>
                  <el-form-item label="邮政编码" prop="postalCode" class="add-form-input">
                    <el-input :disabled="!isAble" v-model="form.postalCode"  placeholder="请输入" />
                  </el-form-item>
              ...
              :disabled="!isAble"
                  ...
                  <el-form-item label="考勤卡号" prop="attendanceNumber" class="add-form-input">
                    <el-input :disabled="!isAble" v-model="form.attendanceNumber" placeholder="请输入" />
                  </el-form-item>
              ...
              :disabled="!isAble"
                  ...
                  <el-form-item label="特长" prop="Specialty" class="add-form-input">
                    <el-input :disabled="!isAble" v-model="form.Specialty" placeholder="请输入" />
                  </el-form-item>
                  ...
                  <el-form-item label="紧急联系人姓名" prop="urgentLinkMan" class="add-form-input label_1">
                    <el-input  :disabled="!isAble" v-model="form.urgentLinkMan" placeholder="请输入" />
                  </el-form-item>
                  <el-form-item label="紧急联系方式" prop="urgentLinkManPhone" class="add-form-input">
                    <el-input :disabled="!isAble" v-model="form.urgentLinkManPhone" placeholder="请输入" />
                  </el-form-item>
...
import WkUploadFile from '@/components/CreateCom/WkUploadFile'
  ...
  export default {
    ...
    //接收参数
    props:["UID","actionType"],
    created() {
	
	  if (this.actionType == 'details') {
		  this.isAble = false;
	  } else {
		  this.isAble = true;
	  }
      ...
      if(this.actionType != null && this.actionType != 'save'){
        this.getInfo()
      } 
    ...
    methods: {
      ...
      submitForm: function() {
        ...
        this.$refs['form'].validate(valid => {
		  ...
		  // 添加项目id 
		  this.cerForm.projectId = this.form.projectId
