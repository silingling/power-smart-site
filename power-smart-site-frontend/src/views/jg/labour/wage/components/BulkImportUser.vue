    ...
    <div class="dialog-body">
      ...
      <div
        ...
        <div class="content content-tips">
          <div>操作步骤：</div>
          <div>1、下载《考勤导入模板》</div>
          <div>2、打开《考勤导入模板》将对应字段信息输入或粘贴进本表。为保障粘贴信息被有效导入，请使用纯文本或数字</div>
          <div>3、信息输入完毕，点击“选择文件”按钮，选择excel文件上传</div>
          <div>4、点击“确定”开始进行考勤导入</div>
        </div>
      </div>
...
export default {
  ...
  /*    downloadFileAPI('/adminFile/down/123').then(res => {
      ...
      window.open("http://www.oceanus-health.com/hdwxsc/wx/jump/download2?id=1b6977f45e87422ea8db96c5b81b42bd")
    },
