...
<!--          <el-button
      ...
      <el-row >
        ...
        <el-col :span="24">
            ...
            <el-table v-loading="loading" :data="dataList" height="280px" @row-click="infocollectionSelect" @sort-change="sortChange" @selection-change="handleSelectionChange">
              ...
              <el-table-column :formatter="attendanceSubcontractorFc" label="分包单位" align="center" prop="wageSubcontractor" sortable="custom" width="200px" show-overflow-tooltip/>
              <el-table-column :formatter="attendanceWorkIdFc" label="劳务工种" align="center" prop="wageWorkId" width="100px" sortable="custom" show-overflow-tooltip/>
              <el-table-column label="班组长名称" align="center" prop="updateBy" show-overflow-tooltip sortable="custom" width="100px"/>
              <el-table-column label="年月" align="center" prop="wageMonth" width="120px" show-overflow-tooltip sortable="custom"/>
              <el-table-column label="人数" align="center" prop="infocollectionNumber" width="100px" show-overflow-tooltip sortable="custom"/>
              <el-table-column label="总工日" align="center" prop="wageManDays" width="100px" show-overflow-tooltip sortable="custom"/>
              <el-table-column label="总出勤" align="center" prop="wageQuantities" width="100px" show-overflow-tooltip sortable="custom"/>
              <el-table-column label="应发工资(元)" align="center" prop="wageShould" show-overflow-tooltip width="120px" sortable="custom"/>
              <el-table-column label="预支工资(元)" align="center" prop="wageDvance" show-overflow-tooltip width="120px" sortable="custom"/>
              <el-table-column label="累计剩余(元)" align="center" prop="wageaCumulativeBalance" show-overflow-tooltip width="120px" sortable="custom"/>
          ...
          <el-table v-loading="loading" :data="infocollectionListAdd" height="240px" >
            ...
            <el-table-column label="点工(日工)" align="center">
              <el-table-column label="日单价" align="center" prop="dayPrice">
                <template slot-scope="scope">
                  <el-input v-model="scope.row.dayPrice" size="small" :disabled="!isAdd" @input="changeInput1(scope.row.dayPrice,scope.row.id,scope.row)" />
                </template>
              </el-table-column>
              <el-table-column label="工日（天）" align="center" prop="manDays">
                <template slot-scope="scope">
                  <el-input v-model="scope.row.manDays" size="small" :disabled="!isAdd" @input="changeInput1(scope.row.manDays,scope.row.id,scope.row)" />
                </template>
              </el-table-column>
            </el-table-column>
            <el-table-column label="包工" align="center">
              <el-table-column label="工程量单价" align="center" prop="quantitiesPrice">
                <template slot-scope="scope">
                  <el-input v-model="scope.row.quantitiesPrice" size="small" :disabled="!isAdd" @input="changeInput1(scope.row.quantitiesPrice,scope.row.id,scope.row)" />
                </template>
              </el-table-column>
              <el-table-column label="工程量" align="center" prop="quantities">
                <template slot-scope="scope">
                  <el-input v-model="scope.row.quantities" size="small" :disabled="!isAdd" @input="changeInput1(scope.row.quantities,scope.row.id,scope.row)" />
                </template>
              </el-table-column>
            </el-table-column>
            <el-table-column :formatter="formatterTime" label="发放日期" align="center" prop="issueDate" />
            ...
            <el-table-column label="预支工资(元)" align="center" prop="wageDetailAdvance">
              <template slot-scope="scope">
                <el-input v-model="scope.row.wageDetailAdvance" size="small" :disabled="!isAdd" @input="changeInput1(scope.row.wageDetailAdvance,scope.row.id,scope.row)" />
              </template>
            </el-table-column>
            <el-table-column label="本月余额(元)" align="center" prop="monthBalance" />
            <el-table-column label="累计剩余(元)" align="center" prop="cumulativeBalance" />
            ...
            <el-table-column label="实发金额(元)" align="center" prop="actualAmount">
              <template slot-scope="scope">
                <el-input v-model="scope.row.actualAmount" size="small" :disabled="!isAdd" @input="changeInput1(scope.row.wageDetailAdvance,scope.row.id,scope.row)"/>
              </template>
            </el-table-column>
            ...
            <el-table-column label="第三方工资单编号" align="center" prop="thirdPayRollCode">
              <template slot-scope="scope">
                <el-input v-model="scope.row.thirdPayRollCode" size="small" :disabled="!isAdd" @input="changeInput1(scope.row.wageDetailAdvance,scope.row.id,scope.row)"/>
              </template>
            </el-table-column>
          </el-table>
        </el-form>
...
　　})
  ...
  methods: {
    ...
    changeInput1(value, ids, row) {
      ...
      row.actualAmount = row.monthBalance
      Editdata = {
        ...
        if (valid) {
          ...
          request({
            ...
            if (response2.data == 1) {
              ...
              this.fullscreenLoading = false
              if (response2.data == 4) {
                this.msgSuccess('该班组所选月份已存在数据，不可重复添加！')
              }
              if (response2.data == 5) {
                this.msgSuccess('该班组下不存任何人员数据！')
              }
              if (response2.data == 6) {
                this.msgSuccess('该班组下不存在考勤数据！')
              }
            }
          })
        }
