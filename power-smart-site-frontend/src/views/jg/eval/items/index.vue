<template>
  <div>
	...
	<el-form-item label="应用类别" prop="classType">
	  <el-select v-model="queryParams.classType" placeholder="请选择应用类别">
		<el-option
	...
	<el-form-item label="分项类型" prop="itemType">
	  <el-select v-model="queryParams.itemType" placeholder="请选择分项类型">
	    <el-option
      ...
      <el-form-item>
        ...
        <el-button type="primary" @click="bulkImportClick">评分导入</el-button>
      </el-form-item>
...
<script>
  ...
  import {getList, updateStatusData} from "../api/items"
...
//    },
      ...
      deleteClick(id) {
        this.$confirm("确定删除选中的数据吗？", '提示', {
          ...
          .then(() => {
            ...
            this.loading = true;
            updateStatusData(params).then(res => {
              if (res.code == 0) {
      ...
      bulkImportClick() {
        ...
        this.param = {
          ...
          url:'build/evalItems/excelImport'
        }
