<template>
  <div>
	...
	<el-form-item label="项目名称" prop="projectId">
	  ...
	  <el-form-item label="评价等级" prop="appLevel">
	    <el-input
	      v-model="queryParams.appLevel"
	      placeholder="请输入工地名称"
	      clearable
	      size="small"
	...
	<!-- <el-form-item label="评价等级" prop="levelId">
...
<script>
  ...
  import {getList, applyRefuse, getProjectsList} from "../api/evalRanking"
