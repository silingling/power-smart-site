	...
	<div>
		...
		<el-form v-show="true" ref="queryForm" :model="queryParams" :inline="true" label-width="80px" style="padding: 20px 20px 0px 20px;background-color: white;border-top: 0px solid #e6e6e6;">
			...
			<el-form-item label="能源名称" prop="energyName">
				<el-select v-model="queryParams.energyName" clearable placeholder="请选择">
			...
			<el-form-item label="超限类型" prop="transfiniteType">
				<el-select v-model="queryParams.transfiniteType" clearable placeholder="请选择">
					<el-option v-for="item in transfiniteTypeOptions" :key="item.value" :label="item.label" :value="item.value">
					</el-option>
				</el-select>
			</el-form-item>
			<el-form-item>
		...
		<div class="table-head-container">
			...
			<el-table v-loading="loading" id="crm-table" :data="list" :height="tableHeight" :cell-class-name="cellClassName" class="n-table--border" use-virtual stripe border highlight-current-row style="width: 100%" @sort-change="sortChange">
