        ...
        <el-table-column label="操作" align="center" class-name="small-padding fixed-width" width="200px"
          ...
          <template slot-scope="scope">
            <el-button
              ...
              type="text"
              icon="el-icon-edit"
              @click="updateClick(scope.row.platformId)"
            >修改
            </el-button>
            <el-button
              size="mini"
              type="text"
              icon="el-icon-delete"
              @click="deleteClick(scope.row.platformId)"
            >删除
            </el-button>
          </template>
        </el-table-column>
...
<script>
  ...
  import {getList, delTrueByIds, deployExchange} from "../api/platform.js";
  ...
  export default {
    ...
    methods: {
       ...
       */
      deployClick(id) {
        this.$confirm("请谨慎操作：部署将会丢失正在交换的数据，需要继续吗？", '提示', {
