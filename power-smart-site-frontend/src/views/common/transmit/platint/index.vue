	...
	<div>
		<el-form v-show="true" ref="queryForm" :model="queryParams" :inline="true" label-width="80px"
			...
			<el-form-item label="对接平台">
				<el-input v-model="queryParams.platformId" placeholder="请输入对接平台" clearable size="small"
					@keyup.enter.native="getList" />
			</el-form-item>
			<el-form-item label="接口地址">
				<el-input v-model="queryParams.url" placeholder="请输入接口地址" clearable size="small"
					@keyup.enter.native="getList" />
			</el-form-item>
			<el-form-item>
				...
				<el-table-column label="操作" align="center" class-name="small-padding fixed-width" width="200px"
					...
					<template slot-scope="scope">
						<el-button size="mini" type="text" icon="el-icon-edit"
							@click="updateClick(scope.row.platintId)">修改
						</el-button>
						<el-button size="mini" type="text" icon="el-icon-delete"
							@click="deleteClick(scope.row.platintId)">删除
						</el-button>
					</template>
				</el-table-column>
			</el-table>
