  ...
  <create-view
    ...
    <flexbox
        ...
        <div
          ...
          <div style="padding: 0 20px; font-size: 12px;">
            ...
            <div class="examine-add-des">
              ...
              <p><span class="examine-add-required">*</span>当选择“指定用户（任意一人）”表示指定用户中任意一人审批即可。当选择“指定用户（多人会签）”表示
                指定用户中所有人都要审批。</p>
            </div>
            <el-radio
              v-model="examineType"
      ...
      <div
        ...
        <el-button
          class="handle-button"
          @click.native="hidenView">取消
        </el-button>
        <el-button
          class="handle-button"
          type="primary"
          @click.native="nextPage">下一页
        </el-button>
      </div>
      <div
        v-if="currentPage == 2"
        ...
        <el-button
          class="handle-button"
          type="primary"
          @click.native="saveField">保存
        </el-button>
        <el-button
          class="handle-button"
          type="primary"
          @click.native="currentPage = 1">上一页
        </el-button>
      </div>
    </flexbox>
  </create-view>
...
<script type="text/javascript">
  ...
  import {examineSaveAPI} from '@/components/common/examine/api'
  ...
  export default {
    name: 'CreateExamine', // 所有新建效果的view
    components: {
      CreateView,
      XhInput,
      XhTextarea,
    ...
    methods: {
      ...
      getField() {
        const field = [];
        adminGetBTypeAPI().then(res => {
          const categoryTypeList = res.data;
          field.push({
            field: 'name',
            formType: 'text',
            isNull: 1,
          ...
          field.push({
            ...
            value: this.handle.data ? this.handle.data.categoryType : categoryTypeList[0].value
          })
      ...
      submiteParams(array) {
        ...
        examineSaveAPI(params).then(res => {
          this.loading = false
          this.hidenView()
