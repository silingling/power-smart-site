...
import RelativeExpense from '../components/RelativeExpense' // 费用
...
import RelativeReturnMoney from "../components/RelativeReturnMoney";
...
export default {
  ...
  computed: {
    ...
    tabNames() {
      ...
      if (this.crm.invoice && this.crm.invoice.index) { //TODO 权限是否需根据审批权限筛选？
        tempsTabs.push({ label: this.getTabName('费用', this.tabsNumber.moneyCount), name: 'RelativeExpense' })
      }
