              ...
              <div
                ...
                <flexbox align="stretch">
                  ...
                  <div class="element-label">
                    <i v-if="element.isMilestone==1" class="wk wk-tag" style="color:#f56c6c;margin-right: 2px"></i>{{ element.name }}<span v-if="element.workName">（{{ element.workName }}）</span></div>
                  <xr-avatar
  ...
  methods: {
    ...
    detailHandle(data) {
      if (data.index == 0 || data.index) {
        ...
        } else if (data.type == 'set-milestone') {
          this.taskList[data.section].list[data.index].isMilestone = data.value
        }
      }
    },
