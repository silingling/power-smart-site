          ...
          <el-tab-pane
            ...
            <el-dropdown slot="label" trigger="click" @command="tabShowType = $event">
              ...
              <el-dropdown-menu slot="dropdown">
                ...
                <el-dropdown-item command="gantt">甘特视图</el-dropdown-item>
...
export default {
  ...
  computed: {
    ...
    // tabs 下内容视图的组件
    showComponent() {
      // console.log("this.activeName=="+JSON.stringify(this.activeName))
      // console.log("this.tabShowType=="+JSON.stringify(this.tabShowType))
      if (this.activeName == 'task-board') {
        if (this.tabShowType == 'list') {
          return 'TaskListBoard'
        }
        if (this.tabShowType == 'gantt') {
          return 'TaskGantt'
        }
  ...
  methods: {
     ...
     * 任务筛选
     */
    taskScreeningChange(userIds, timeId, tagIds, search, isMilestone) {
