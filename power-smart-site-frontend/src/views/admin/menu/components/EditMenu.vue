    ...
    <el-form
      ...
      <el-col :span="24">
        <el-form-item
          label="菜单类型"
          prop="menuType">
          <el-radio-group v-model="menuForm.menuType" :disabled="menuTypeDisabled">
            <el-radio :label="1" disabled="true">应用</el-radio>
            <el-radio :label="2">菜单</el-radio>
            <el-radio :label="3">按钮</el-radio>
            <el-radio :label="4">特殊</el-radio>
            <el-radio :label="5">手机端</el-radio>
          </el-radio-group>
        </el-form-item>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item
          label="权限标识"
          prop="realm">
          <el-input v-model="menuForm.realm" />
        </el-form-item>
      </el-col>
      <el-col :span="24">
        <el-form-item
          label="权限URL"
          prop="realmUrl">
          <el-input v-model="menuForm.realmUrl" />
        </el-form-item>
      </el-col>
      <el-col :span="12">
        <el-form-item
      ...
      <el-col :span="12">
        <el-form-item
          label="强制活跃路由"
          prop="activePath">
          <el-input v-model="menuForm.activePath"/>
        </el-form-item>
      </el-col>
      <el-col :span="12">
        <el-form-item
          label="是否禁用"
          prop="isDisabled">
          <el-radio-group v-model="menuForm.isDisabled">
            <el-radio :label="'0'">否</el-radio>
            <el-radio :label="'1'">是</el-radio>
          </el-radio-group>
        </el-form-item>
...
export default {
  ...
  mounted() {//渲染完成后
    ...
    var menuType = this.menuForm.menuType;
    if(menuType == 1){
