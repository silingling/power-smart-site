...
export default {
  ...
  computed: {
    ...mapGetters(['manage','navActiveIndex','allAuth',]),
    systemSaveAuth() {
  ...
  created() {
    this.getDetail()
    //console.log(this.navActiveIndex,this.allAuth,this.allAuth[this.navActiveIndex])
  },
  methods: {
    /** 附件上传 */
...
//    reader.readAsDataURL(content.file)
    this.systemImage=URL.createObjectURL(content.file);
    this.editedImage=content.file
    },
    deleteSystemImage() {
      this.systemImage = ''
