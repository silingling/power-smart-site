  ...
  <flexbox v-loading="loading" :style="{height: contentHeight + 'px'}" class="calendar-box">
    ...
    <div class="box-left">
      <div class="left-title" >
        <img   :onerror='`this.src="${require("@/assets/noimgsrc.png")}"`'    width="20px" src="@/assets/img/system/app/ce_index.png" alt="">
        <xh-user-cell
          v-if="showUser"
          ref="xhuserCell"
          :value="checkedUser"
      ...
      <div class="left-scroll">
        ...
        <div class="left-main">
          <div class="main-title" @click="showSys = !showSys">
            <img   :onerror='`this.src="${require("@/assets/noimgsrc.png")}"`'    src="@/assets/img/calendar_sys.png" alt="" width="20px">
        ...
        <div class="left-bottom">
          <div class="bottom-title" @click="showCus = !showCus">
            <img   :onerror='`this.src="${require("@/assets/noimgsrc.png")}"`'    src="@/assets/img/calendar_cus.png" alt="" width="20px">
