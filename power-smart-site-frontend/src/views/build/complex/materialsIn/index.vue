	...
	<div class="main">
		<div class="main-body">
			...
			<el-table ref="menuTable" :data="paperRuleDataList" style="width: 100%" :height="tableHeight" border v-loading="loading" @sort-change="sortChange">
				...
				<el-table-column prop="specification" align="center" label="规格" width="120" show-overflow-tooltip sortable="custom"></el-table-column>
				<el-table-column prop="model" align="center" label="型号" width="120" show-overflow-tooltip sortable="custom"></el-table-column>
				<el-table-column prop="inNumber" align="center" label="进场数量" width="120" show-overflow-tooltip sortable="custom"></el-table-column>
				<el-table-column prop="unit" align="center" label="计量单位" width="120" show-overflow-tooltip sortable="custom"></el-table-column>
				<el-table-column prop="inTime" align="center" label="进场时间" width="180" show-overflow-tooltip sortable="custom"></el-table-column>
				<el-table-column prop="qualifiedCertificate" align="center" label="合格证件" width="140" show-overflow-tooltip sortable="custom"></el-table-column>
				<el-table-column prop="materialClerk" align="center" label="材料员" width="120" show-overflow-tooltip sortable="custom"></el-table-column>
				<el-table-column prop="deliveryMan" align="center" label="送货人" width="120" show-overflow-tooltip sortable="custom"></el-table-column>
...
<script>
	...
	import {getList, selectById, delById } from '@/views/build/complex/api/materialsIn'
  ...
  import { sortColumn } from '@/utils/index';
	...
	export default {
        ...
        queryParams:{},//搜索
				...
				currentMenu: {}, //当前施工综合-物料进场
				paperRuleDataList: [], //施工综合-物料进场列表
