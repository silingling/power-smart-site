...
<!--      label="项目授权管理"/>-->
    <div class="main-body">
      ...
      <el-table v-loading="loading" :height="tableHeight" v-if="isList" :data="typeList"
                highlight-current-row @row-click="handleRowClick" :cell-class-name="cellClassName" @sort-change="sortChange">
        <el-table-column label="序号" type="index"  align='center' width="70"></el-table-column>
        <el-table-column label="公司名称" align="center" prop="companyName" width="200px" show-overflow-tooltip sortable="custom"/>
        <el-table-column label="项目名称" align="center" prop="projectName" width="250px" sortable="custom"/>
        <el-table-column label="项目地址" align="center" prop="projectAddress" width="200px" show-overflow-tooltip sortable="custom"/>
        <el-table-column label="总造价（万元）" align="center" prop="totalCost"  width="140px" sortable="custom"/>
        <el-table-column label="总面积（平方米）" align="center" prop="totalArea" width="160px" sortable="custom"/>
        <el-table-column label="总造价（万元）" align="center" prop="totalCost"  width="140px" sortable="custom"/>
        ...
        <el-table-column label="工程状态" align="center" prop="engineeringStatus" :formatter="engineeringStatusFormat" sortable="custom"/>
