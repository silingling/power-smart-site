<template>
	<div class="main">
		...
		<el-table ref="menuTable" :data="tableDataList" style="width: 100%" :height="tableHeight" border v-loading="loading" highlight-current-row >
			...
			<el-table-column prop="detailContent" align="center" label="明细内容" width="140"></el-table-column>
			...
			<el-table-column prop="totalRentalPriceNotTax" align="center" label="租赁总价不含税" width="120"></el-table-column>
			...
			<el-table-column prop="planMonthDetailId" align="center" label="月计划节点" width="120" :formatter="planMonthIdAndNameFormmater"></el-table-column>
...
<script>
	...
	import {getList, selectById, delById } from '@/views/build/progress/api/monthEquipmentLease'
	...
	export default {
		...
		data() {
			return {
				...
				currentMenu: {}, //当前月计划设备租赁明细
				tableDataList: [], //月计划设备租赁明细列表
				...
				planMonthIdAndNameList:[],//月计划id和name的list
