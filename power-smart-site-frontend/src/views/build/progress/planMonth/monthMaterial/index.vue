<template>
	<div class="main">
		...
		<el-table highlight-current-row ref="menuTable" :data="tableDataList" style="width: 100%" :height="tableHeight" border v-loading="loading" >
			...
			<el-table-column prop="materialName" align="center" label="材料名称" width="140" ></el-table-column>
			<el-table-column prop="materialType" align="center" label="材料类型" ></el-table-column>
			...
			<el-table-column prop="allPrice" align="center" label="合价(含税)"></el-table-column>
			<el-table-column prop="warehousingTime" align="center" label="入库时间" width="180"></el-table-column>
			<el-table-column prop="planMonthDetailId" align="center" label="月计划节点" :formatter="planMonthIdAndNameFormmater"></el-table-column>
...
<script>
	...
	import {getList, selectById, delById , exportExcel} from '@/views/build/progress/api/monthMaterial'
