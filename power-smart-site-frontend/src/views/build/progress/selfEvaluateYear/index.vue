				...
				<el-table-column type="expand">
						<template slot-scope="props">
							<div class="expand_div">
								<el-table :data="tableData"  class="n-table--border"   stripe style="width: 100%">
									<el-table-column prop="securityEvaluationName" label="评定项目" align="center">
									</el-table-column>
									<!-- <el-table-column prop="securityEvaluationStandard" label="评定标准" show-overflow-tooltip align="center">
									</el-table-column> -->
		...
		methods: {
			...
			informClick(id) {
				...
				getPrintData(id).then(printData => {
					queryPrintTemplateByType(10050).then(res => {
