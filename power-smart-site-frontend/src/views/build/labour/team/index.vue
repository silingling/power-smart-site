  ...
  <div class="main">
    ...
    <div class="main-body">
      ...
      <el-table v-loading="loading" :height="tableHeight" :data="dataList" @sort-change="sortChange">
        ...
        <el-table-column label="班组名称" align="center" prop="teamName" width="250px" sortable="custom"/>
        <el-table-column label="班组长名" align="center" prop="teamLeaderName" width="120px" sortable="custom"/>
        <el-table-column label="身份证号" align="center" prop="idCard" sortable="custom"/>
        <el-table-column label="分包单位" align="center" prop="subcontractorName" show-overflow-tooltip sortable="custom"/>
        <el-table-column label="劳务工种" align="center" prop="dictLabel" sortable="custom"/>
        <el-table-column label="班组首拼" align="center" prop="teamSpell" sortable="custom"/>
        <el-table-column label="联系方式" align="center" prop="phone" sortable="custom"/>
