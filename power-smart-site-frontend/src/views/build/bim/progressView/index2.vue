...
<!--            <iframe src="http://101.200.143.182:8889/bim.html" style="width:100%; height:720px"></iframe>-->
            <!--<iframe src="static/progressView.html" style="border:0px; width:100%; height:720px"></iframe>-->
          </el-col>
        </el-row>
...
export default {
  ...
  data() {
    return {
      loading: false,
      viewToken: '58cf133c5133456f9f7892c4016e8d80',//模型生长：https://bimface.com/developer-jsdemo#1108
      viewer3D:'',
      app:'',
      sectionPlane : null,
