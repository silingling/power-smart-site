  ...
  <div>
    ...
    <el-form v-show="true" ref="queryForm" :model="queryParams" :inline="true" label-width="80px"
      ...
      <el-form-item label="监测类型">
        <el-select v-model="queryParams.monitorTypeList" multiple collapse-tags clearable placeholder="请选择监测项类型">
          <el-option
          ...
          <template slot-scope="props">
            ...
            <div class="expand_div">
              <el-table class="n-table--border" :data="positionJSON[props.row.assetId]"
                        style="width: 100%"
              >
                <el-table-column label="监测项名称" align="center" prop="pointName" sortable="custom">
                </el-table-column>
                ...
                <el-table-column label="更新时间" width="250" align="center" prop="dataUpdateTime" />
              </el-table>
            </div>
          </template>
        </el-table-column>
...
<script>
  ...
  export default {
    ...
    mounted() {
	  ...
	  this.$route.params.monitorTypeList!=undefined&&this.$route.params.monitorTypeList!=''?
	  this.$set(this.queryParams,'monitorTypeList',this.$route.params.monitorTypeList):''

	  this.$route.params.online!=undefined&&this.$route.params.online!=''?
	  this.$set(this.queryParams,'online',this.$route.params.online):''
      // // 获取字典数据
      this.initDicts()
