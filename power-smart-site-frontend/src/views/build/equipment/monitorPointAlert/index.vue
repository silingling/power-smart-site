...
//      },
  ...
  mounted() {
    ...
    this.$route.query.monitorType!=undefined&&this.$route.query.monitorType!=''?
    this.$set(this.queryParams,'monitorType',this.$route.query.monitorType):''

   this.$route.query.pointName!=undefined&&this.$route.query.pointName!=''?
    this.$set(this.queryParams,'pointName',this.$route.query.pointName):''

    this.$route.query.alertType!=undefined&&this.$route.query.alertType!=''?
    this.$set(this.queryParams,'alertType',this.$route.query.alertType):''
    ...
    this.$route.params.executeDates!=undefined&&this.$route.params.executeDates!=''?
    (this.executeDates = this.$route.params.executeDates):''
