<template>
  <div class="main">
    ...
    <div class="main-body">
      <el-form class="my-form" v-show="showSearch" ref="queryForm" :model="queryParams" :inline="true" label-width="68px" style="padding: 20px 20px 0px; background-color: white; border-top: 0px solid rgb(230, 230, 230);">
        <el-row>
          <el-col :span="4">
      ...
      <el-table v-loading="loading" :data="typeList"
        ...
        <el-table-column label="执行时间" prop="setDate" show-overflow-tooltip sortable="custom">
          <template slot-scope="scope">
  ...
  export default {
    ...
    methods: {
      ...
      getList() {
        ...
        if(this.queryParams.searchSetDate!=null&&this.queryParams.searchSetDate!=''){//日期查询
          ...
          this.queryParams.searchEndDate = this.queryParams.searchSetDate[1];
        	...
        	this.queryParams.searchStartDate = '';
          this.queryParams.searchEndDate = '';
        }
