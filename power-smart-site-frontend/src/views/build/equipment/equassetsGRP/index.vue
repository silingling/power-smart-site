        ...
        <div class="flex-box">
          <el-table
			...
			<el-table-column
			  prop="projectName"
			  label="所属项目"
			  width="200" show-overflow-tooltip sortable="custom">
			</el-table-column>
            <el-table-column
              prop="assetName"
              label="设备名称" show-overflow-tooltip width="180" sortable="custom">
            ...
            <el-table-column
              prop="sort"
              label="排序"
              width="80" show-overflow-tooltip sortable="custom">
            </el-table-column>
            <el-table-column
              fixed="right"
              label="操作"
...
<script>
  ...
  export default {
    ...
    this.$route.query.typeId!=undefined&&this.$route.query.typeId!=''?
    this.$set(this.currTree,'id',this.$route.query.typeId):''
      var self = this
      /** 控制table的高度 */
