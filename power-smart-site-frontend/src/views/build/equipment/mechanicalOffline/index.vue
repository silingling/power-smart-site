	...
	<div>
      ...
      <el-form-item label="设备类型">
		...
		<div class="table-head-container">
			<el-table v-loading="loading" id="crm-table" :data="list" @sort-change="sortChange" :height="tableHeight"
...
<script>
	...
	import {
		selectOfflinePage,getAssetType
        ...
        getAssetType().then(res => {
          ...
          .catch(() => {
			...
			getList() {
				...
				selectOfflinePage(this.queryParams)
					.then(res => {
			...
			fieldFormatter(row, column, cellValue) {
			  var that = this;
				...
				}else if(column.property == "typeId"){
          var typeName = "";
          that.assetType.forEach(function(val,i){
            if(cellValue == val.typeId){
