          ...
          <el-form ref="equform" :model="form" :rules="rules" label-width="80px;background-color:#fff" style="padding: 40px 40% 0px 40px">
            ...
            <el-row>
              <el-col :span="12" style="padding: 5px">
                <el-form-item label="上级位置编号">
                  <el-input v-model="form.locationPcode" :disabled="true"></el-input>
                </el-form-item>
              </el-col>
              <el-col :span="12" style="padding: 5px">
                <el-form-item label="上级位置名称">
                  <el-input v-model="form.locationPname" :disabled="true"></el-input>
                </el-form-item>
              </el-col>
            </el-row>
            <el-row>
              <el-col :span="12" style="padding: 5px">
                <el-form-item label="位置编号"  prop="locationCode">
                  <el-input v-model="form.locationCode" placeholder="请输入编号"></el-input>
                </el-form-item>
              </el-col>
              <el-col :span="12" style="padding: 5px">
...
export default {
  ...
  methods: {
    ...
    add(){
      var data = this.form;
      this.form = {};
      this.form.locationPid = data.locationId;
      this.form.locationPcode = data.locationCode;
      this.form.locationPname = data.locationName;
    ...
    del(){
      ...
      if(this.currTree.children&&this.currTree.children.length!=0){
        this.$message({
          type: 'info',
          message: '存在下级数据，不得删除'
        });
