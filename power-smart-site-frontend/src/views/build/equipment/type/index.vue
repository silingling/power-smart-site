...
<!--    </xr-header>-->
    <div class="system-content" v-loading="formLoading">
      <!-- 左边导航栏 -->
      <div
      ...
      <div class="system-view-table flex-index" >
        ...
        <div class="flex-box">
          <el-form ref="equform" :model="form" :rules="rules" label-width="80px;background-color:#fff" style="padding: 40px 40% 0px 40px">
            ...
            <el-row>
              ...
              <el-col :span="12" style="padding: 5px">
                <el-form-item label="监测项类型" prop="monitorType">
                  <el-select style="width: 100%;" v-model="form.monitorType" placeholder="请选择监测项类型">
                    <el-option
                      v-for="item in monitorTypeDict"
                      :key="item.dictValue"
            ...
            <el-row>
              <el-col :span="12" style="padding: 5px">
                <el-form-item label="设备信息扩展" prop="ifExpInfo">
                  <el-radio-group v-model="form.ifExpInfo">
              ...
              <el-col :span="12" style="padding: 5px">
                <el-form-item label="扩展前端组件" prop="expInfoCom">
                  <el-input v-model="form.expInfoCom" placeholder="请输入"></el-input>
                </el-form-item>
              </el-col>
            </el-row>
            <!--<el-row>
              <el-form-item label="设备分布图"></el-form-item>
            ...
            <el-row>
              <el-col :span="12" style="padding: 5px">
                <el-form-item label="入库缓存" prop="ifRecCache">
                  <el-radio-group v-model="form.ifRecCache">
                    <el-radio :label="'0'">否</el-radio>
                    <el-radio :label="'1'">是</el-radio>
                  </el-radio-group>
                </el-form-item>
              ...
              <el-col :span="12" style="padding: 5px">
                <el-form-item label="缓存周期（Cron）" prop="recCacheCyc">
                  <el-input v-model="form.recCacheCyc" placeholder="请选择" readonly="" style="width: calc(100% - 60px);"></el-input>
                  <el-button type="primary" @click="showCronDialog()" style="display: inline;">选择</el-button>
                </el-form-item>
              </el-col>
            </el-row>
            <!--<el-row style="border-bottom: 1px solid #e6e6e6;padding-bottom: 10px">
    ...
    <el-dialog title="缓存周期" :visible.sync="showCron">
...
export default {
  ...
  methods: {
    crontabFill(value) {
      //确定后回传的值
      this.form.recCacheCyc = value;
    },
    showCronDialog() {
      console.log('click')
      this.expression = this.form.recCacheCyc;
      this.showCron = true;
    },
    //改变展开状态
    changeExpanded(node) {
    ...
    getTypeById(id){
      typeGet(id)
        .then(data => {
          if(data.code == 0){
            this.form = data.data;
            this.systemAddPlaneImage = data.data.planeImg;
          }else{
    ...
    del(){
      ...
      if(this.currTree.children.length > 0){
        this.$message({
          type: 'info',
          message: '存在下级数据，不得删除'
        });
