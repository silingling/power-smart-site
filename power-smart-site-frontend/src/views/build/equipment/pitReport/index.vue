...
<!--    </div>-->
    ...
    <el-form v-show="true" ref="queryForm" :model="queryParams" :inline="true" label-width="80px"
      ...
      <el-form-item label="观测单位">
        <el-input
          v-model="queryParams.observeUnit"
          placeholder="请输入观测单位"
          clearable
          size="small"
          @keyup.enter.native="getList"
...
<script>
  ...
  import {getList,delTrueByIds} from "../api/pitReport"
