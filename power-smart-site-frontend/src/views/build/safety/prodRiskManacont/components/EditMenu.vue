<template>
  <el-dialog
    ...
    <el-form
      ...
      label-width="100px">
         ...
         <el-col :span="12">
            <el-form-item
              label="管控源"
              prop="prodRiskName">
              <el-input v-model="menuForm.prodRiskName"/>
            </el-form-item>
         </el-col>
         <el-col :span="12">
            <el-form-item
      ...
      <el-row>
        <el-col :span="12">
            <el-form-item label="风险评定等级" prop="riskRating" class="add-form-input">
              <el-select
                      v-model="menuForm.riskRating"
                      placeholder="请选择"
                      clearable
                      size="small"
                      style="width: 280px;"
                      >
                <el-option
                        v-for="dict in riskRatingOptions"
                        :key="dict.dictValue"
      ...
      <el-row>
         <el-col :span="12">
            <el-form-item
              ...
              <el-input v-model="menuForm.riskIdenInstructions" :row="2"
                        :maxlength="300"
                        type="textarea"/>
            </el-form-item>
         </el-col>
  ...
  data() {
    return {
      ...
      memuRules: {
        ...
        // riskRating: [
        //   { required: true, message: '风险评定等级不能为空', trigger: 'blur' }]
      },
      // 自定义字段信息表单
      menuForm: {
      },
