  ...
  <div class="main">
    ...
    <div class="main-body">
      ...
      <el-table v-loading="loading" :height="tableHeight" :data="dataList" @sort-change="sortChange">
        ...
        <el-table-column label="分部分项" :formatter="SubItemWorksPartsFc" align="center" prop="riskName" :show-overflow-tooltip="true" sortable="custom" />
        <el-table-column label="风险类型" align="center" prop="riskType" :show-overflow-tooltip="true" sortable="custom" />
        <el-table-column label="风险辨识点" align="center" prop="riskIdentPoint" :show-overflow-tooltip="true" sortable="custom" />
        <el-table-column label="事故类型" align="center" prop="accidentType" :show-overflow-tooltip="true" sortable="custom" />
        <el-table-column label="风险分级/标识" :formatter="riskLevelIdentFc" align="center" prop="riskLevelIdent" width="140" :show-overflow-tooltip="true" sortable="custom" />
        ...
        <el-table-column label="风险解除状态" :formatter="relieveStatusFc" align="center" prop="relieveStatus" width="140" :show-overflow-tooltip="true" sortable="custom" />
        <el-table-column label="工程措施" align="center" prop="engineeringMeasure" :show-overflow-tooltip="true" sortable="custom" />
        <el-table-column label="个体防护措施" align="center" prop="individualProtection" width="140" :show-overflow-tooltip="true" sortable="custom" />
        <el-table-column label="设备设施名称" align="center" prop="deviceType" width="140" :show-overflow-tooltip="true" sortable="custom" />
...
export default {
  ...
  methods: {
	...
	sortChange(column) {
		if(column.prop == 'riskName') {
			column.prop = 'subItemWorksParts'
		}
