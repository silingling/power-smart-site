...
<script>
  ...
  import {getList} from "../api/mixingPlantData";
  ...
  export default {
    ...
    data() {
      return {
        ...
        fieldList: [//表头
          ...
          {
            prop: "labMaterialName",
            label: "试验室材料种类",
            width: "160"
          },
          {
            prop: "labMaterialVolume",
            label: "试验室材料占比（%）",
            width: "180"
          },
          {
    ...
    methods: {
      ...
      resetQuery() {
        ...
        this.param = {
          title:"拌合站数据导入模板(*)为必填项",
          excelTitle:"拌合站数据导入模板",
          colNames:lists,
          sampleData:dataLists,
          url:'build/safetyMixPlantData/excelImport'
        }
