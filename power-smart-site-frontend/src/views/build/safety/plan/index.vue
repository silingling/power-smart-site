    ...
    <div
      ...
      <el-table
        ...
        <!-- <el-table-column
          ...
          align="center"
          show-overflow-tooltip> -->
          <el-table-column  label="序号"  align='center' type="index" fixed="left" width="60" sortable="custom"/>
          <el-table-column label="方案编号" align="center" prop="code" fixed="left" sortable="custom"/>
          <el-table-column label="方案名称" align="center" prop="name" sortable="custom" />
          <el-table-column label="方案描述" align="center" prop="content" sortable="custom" />
          <el-table-column label="编制日期" align="center" prop="enactDate" width="150px" sortable="custom" />
          <el-table-column label="编制人" align="center" prop="enactBy" width="150px" sortable="custom"/>
          <el-table-column label="交底日期" align="center" prop="jdDate" width="150px" sortable="custom"/>
          <el-table-column label="交底人" align="center" prop="enactBy" width="150px" sortable="custom"/>
        ...
        <el-table-column label="操作" align="center" class-name="small-padding fixed-width" width="200px">
          <template slot-scope="scope">
            ...
            <el-button
            v-if="scope.row.checkStatus == '2' || scope.row.checkStatus == '4'  || scope.row.checkStatus == '5' "
              size="mini"
              type="text"
              icon="el-icon-delete"
  ...
  export default {
    ...
    methods: {
      ...
      cellClassName({row, column, rowIndex, columnIndex}) {
        ...
        // if (column.property === 'examineRecordId') {
        //   return 'can-visit--underline can-visit--bold'
        // }
      },
