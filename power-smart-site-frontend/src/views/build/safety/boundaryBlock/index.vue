	...
	<div class="main">
		<div class="main-body">
			...
			<el-table ref="menuTable" :data="paperRuleDataList" style="width: 100%" :height="tableHeight" border v-loading="loading"  @sort-change="sortChange">
				...
				<el-table-column prop="protectiveNetCode" align="center" label="防护网编号" width="140" sortable="custom"></el-table-column>
				<el-table-column prop="protectiveNetType" align="center" label="防护网形式" width="180" sortable="custom"></el-table-column>
				...
				<el-table-column prop="loftNumber" align="center" label="楼层" sortable="custom"></el-table-column>
				<el-table-column prop="position" align="center" label="位置" sortable="custom"></el-table-column>
...
<script>
	...
	import {getList, selectById, delById } from '@/views/build/safety/api/boundaryBlock'
  ...
  import { sortColumn } from '@/utils/index';
	...
	export default {
        ...
        queryParams:{},//搜索
				...
				currentMenu: {}, //当前边界区块基本信息
				paperRuleDataList: [], //边界区块基本信息列表
