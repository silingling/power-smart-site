  ...
  <div class="main">
    ...
    <div class="main-body">
      ...
      <el-table :height="tableHeight" v-loading="loading" :data="dataList" @sort-change="sortChange">
        ...
        <el-table-column :formatter="trainingPlanIdFc" label="培训计划" align="center" prop="trainingPlanId" sortable="custom" show-overflow-tooltip/>
        <el-table-column :formatter="trainingTypeFc" label="培训类型" align="center" prop="trainingType" sortable="custom" show-overflow-tooltip/>
        <el-table-column label="培训时间" align="center" :formatter="formatterTime" prop="trainingTime" sortable="custom" show-overflow-tooltip/>
        <el-table-column label="培训地点" align="center" prop="trainingAddress" sortable="custom" show-overflow-tooltip/>
        <el-table-column label="培训内容" align="center" prop="trainingContent" sortable="custom" show-overflow-tooltip />
        <el-table-column label="授课人" align="center" prop="trainingTeaching" sortable="custom" show-overflow-tooltip/>
        <el-table-column label="课时" align="center" prop="trainingTeachingTime" sortable="custom" show-overflow-tooltip/>
        <!--<el-table-column label="授课地点" align="center" prop="trainingTeachingAddress" />-->
        <el-table-column label="负责人" align="center" prop="trainingPeople" sortable="custom" show-overflow-tooltip/>
          ...
          <el-row>
            <el-col :span="12">
              <el-form-item label="培训计划" prop="trainingPlanId" class="add-form-input">
                <el-select v-model="form.trainingPlanId" @change="selectChanged" placeholder="请选择" clearable size="small" style="width: 330px">
                  <el-option v-for="dict in trainPlanNames" :key="dict.id" :label="dict.trainPlanName" :value="dict.id" />
                </el-select>
              </el-form-item>
            </el-col>
            ...
            <el-col :span="12">
              <el-form-item label="培训时间" prop="trainingTime" class="add-form-input">
                <el-date-picker v-model="form.trainingTime" type="date" value-format="yyyy-MM-dd HH:mm:ss" placeholder="选择日期" style="width: 330px" />
              </el-form-item>
            </el-col>

            <el-col :span="12">
              <el-form-item label="授课人" prop="trainingTeaching" class="add-form-input">
                <el-input v-model="form.trainingTeaching" placeholder="请输入" />
              </el-form-item>
            </el-col>

            <el-col :span="24">
              <el-form-item label="培训地点" prop="trainingAddress" class="add-form-input">
                <el-input v-model="form.trainingAddress" placeholder="请输入" />
              </el-form-item>
            </el-col>

            <el-col :span="24">
              <el-form-item label="培训内容" prop="trainingContent">
                <el-input :rows="2" v-model="form.trainingContent" type="textarea" placeholder="请输入选项集合" />
              </el-form-item>
            </el-col>

            <el-col :span="12">
              <el-form-item label="课时" prop="trainingTeachingTime" class="add-form-input">
                <el-input v-model.number="form.trainingTeachingTime" type="number" placeholder="请输入" />
              </el-form-item>
            </el-col>
            ...
            <el-col :span="12">
              <el-form-item label="负责人" prop="trainingPeople" class="add-form-input">
                <el-input v-model="form.trainingPeople" placeholder="请输入" />
              </el-form-item>
            </el-col>
