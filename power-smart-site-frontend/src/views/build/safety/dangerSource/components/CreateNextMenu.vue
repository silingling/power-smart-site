<template>
  <el-dialog
    ...
    <el-form
      ...
      <el-form-item
        label="上级危险源">
        <el-input v-model="dangerName2" disabled />
      </el-form-item>
        <el-form-item
          label="危险源"
          prop="dangerName">
          <el-input v-model="menuForm.dangerName" />
        </el-form-item>
      <el-form-item
              label="排  序"
              prop="sort">
...
export default {
  ...
  mounted() {//渲染完成后
    this.loading = false;
    this.menuForm.parentId = this.pdangerSourceId;
    this.dangerName2 = this.dangerNamePop2;
  },
  destroyed() {//销毁后
  },
  methods: {//声明方法
