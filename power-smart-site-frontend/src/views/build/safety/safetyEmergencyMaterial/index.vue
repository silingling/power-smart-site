<template>
  <div>
    ...
    <el-form v-show="true" ref="queryForm" :model="queryParams" :inline="true" label-width="80px"
      ...
      <el-form-item label="物资编号" prop="realName">
        <el-input
          v-model="queryParams.emergencyMaterialNumId"
          placeholder="请输入物资编号"
          clearable
          size="small"
      ...
      <el-form-item label="物资名称" prop="subcontractorType">
        <el-input
       ...
       <el-form-item label="物资类型" prop="emergencyMaterialType">
              <el-select
                    v-model="queryParams.emergencyMaterialType"
                    placeholder="请选择"
                    clearable
                    size="small"
                    style="width: 200px">
      ...
      <el-form-item label="联系电话" prop="emergencyMaterialPhone">
        <el-input
          v-model="queryParams.emergencyMaterialPhone"
          placeholder="请输入联系电话"
          clearable
          size="small"
          @keyup.enter.native="getList"
       ...
       <el-form-item label="负责人" prop="emergencyMaterialPerson">
        <el-input
          v-model="queryParams.emergencyMaterialPerson"
...
<script>
  ...
  import {getList,remove} from "../api/safetyEmergencyMaterial";
  import { sortColumn } from '@/utils/index';

  export default {
    /** DEMO列表 */
    name: 'safetyEmergencyMaterial',
    components: {
      Create,
      // Detail
    },
    ...
    methods: {
      ...
      fieldFormatter(row, column, cellValue) {
        ...
        if(column.property=="emergencyMaterialType"){
          return this.selectDictLabel(this.safetyEmergencyMaterialOptions, row.emergencyMaterialType)
        }else{
          return  row[column.property] === '' || row[column.property] === null ? '--' : row[column.property]
        }
