/**
 * 隐患超期提醒功能 数据源由安全巡检改为安全隐患排查 
 * 原功能为 /src/views/build/safety/inspectionTimeout/index
 */
<template>
  <div>
    <!-- 头部：搜索、操作 start -->
...
<script>
  ...
  import {selectTimeoutList, getSubcontractorList, dangeTimeoutPush} from "../api/riskDetection"
