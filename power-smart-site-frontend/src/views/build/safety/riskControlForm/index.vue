        ...
        <div class="main-body">
            ...
            <el-table v-loading="loading" id="crm-table" :span-method="objectSpanMethod" :data="dataList" :height="tableHeight" :cell-class-name="cellClassName" :header-cell-class-name="headerCellClassName" class="n-table--border" use-virtual stripe border highlight-current-row style="width: 100%" @row-click="handleRowClick" @sort-change="sortChange">
                ...
                <el-table-column align='center' label="风险分级/标识" >
                    <el-table-column align='center' prop="red" label="红" width="120"/>
                    <el-table-column align='center' prop="orange" label="橙" width="120"/>
                    <el-table-column align='center' prop="yellow" label="黄" width="120"/>
                    <el-table-column align='center' prop="blue" label="蓝" width="120"/>
                </el-table-column>
                 <el-table-column align='center' label="管控等级">
                    <el-table-column align='center' prop="one" label="一级" width="120"/>
                    <el-table-column align='center' prop="two" label="二级" width="120"/>
                    <el-table-column align='center' prop="three" label="三级" width="120"/>
                </el-table-column>
            </el-table>
