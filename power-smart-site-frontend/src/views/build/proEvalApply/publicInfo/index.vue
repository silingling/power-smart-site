...
<!--    </div>-->
    ...
    <el-form v-show="true" ref="queryForm" :model="queryParams" :inline="true" label-width="80px"
      ...
      <el-form-item label="公示人">
        <el-input
          v-model="queryParams.publicPeople"
          placeholder="请输入公示人"
          clearable
          size="small"
          @keyup.enter.native="getList"
    ...
    <div
      ...
      <el-table
        ...
        <el-table-column
          ...
          align="center"
          width="55"/>
          <el-table-column label="序号" type="index" show-overflow-tooltip width="60" fixed />
        <el-table-column
...
<script>
  ...
  import {getList, delTrueByIds} from "../api/publicInfo"
