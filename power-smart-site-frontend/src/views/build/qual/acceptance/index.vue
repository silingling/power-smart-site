    ...
    <div class="main">
        <div class="main-body">
            ...
            <el-table v-loading="loading" :data="dataList" :span-method="objectSpanMethod" :border="true"
                ...
                <el-table-column label="验收标准" align="center" prop="criteria" sortable="custom" :show-overflow-tooltip="true" />
...
<!--                </el-table-column>-->
            ...
            <el-dialog :title="title" :visible.sync="open" width="650px" append-to-body :close-on-click-modal="false">
                <el-form ref="form" :model="form" :rules="rules" label-width="100px">
                    <el-row>
                        <el-col :span="12">
                            <el-form-item label="单位工程" prop="unitP">
                                <el-input v-model="form.unitP" placeholder="请输入单位工程" />
                            </el-form-item>
                        </el-col>
                        <el-col :span="12">
                            <el-form-item label="子单位工程" prop="subUnitP">
                                <el-input v-model="form.subUnitP" placeholder="请输入子单位工程" />
                            </el-form-item>
                        </el-col>
                    </el-row>
                    <el-row>
                        <el-col :span="12">
                            <el-form-item label="分部工程" prop="parcelP">
                                <el-input v-model="form.parcelP" placeholder="请输入分部工程" />
                            </el-form-item>
                        </el-col>
                        <el-col :span="12">
                            <el-form-item label="子分部工程" prop="subParcelP">
                                <el-input v-model="form.subParcelP" placeholder="请输入子分部工程" />
                            </el-form-item>
                        </el-col>
                    </el-row>
                    <el-row>
                        <el-col :span="12">
                            <el-form-item label="分项工程" prop="itemP">
                                <el-input v-model="form.itemP" placeholder="请输入分项工程" />
                            </el-form-item>
                        </el-col>
                        <el-col :span="12">
                            <el-form-item label="检验批" prop="inspectionLot">
                                <el-input v-model="form.inspectionLot" placeholder="请输入检验批" />
                            </el-form-item>
                        </el-col>
                    </el-row>
                    <el-form-item label="工程名称" prop="itemName">
                        <el-input type="textarea" v-model="form.itemName" placeholder="请输入工程名称"/>
                    </el-form-item>
                    <el-form-item label="验收标准" prop="criteria" style="width: 100%">
                        <el-input type="textarea" v-model="form.criteria" placeholder="请输入验收标准"/>
                    </el-form-item>
                </el-form>
...
<script>
    import { queryList,queryById, saveOrUpdate, del } from '@/views/build/qual/api/acceptance'
        ...
        methods: {
          ...
          bulkImportClick() {
            ...
            this.param = {
              ...
              url:'build/qualAcceptance/excelImport'
            }
