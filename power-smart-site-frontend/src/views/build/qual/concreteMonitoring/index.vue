  ...
  <div class="main">
    ...
    <div class="main-body">
      ...
      <el-table v-loading="loading" :data="dataList" @sort-change="sortChange">
        <el-table-column label="测温孔名称" align="center" prop="nickId" :formatter="nickIdDescribe" sortable="custom"/>
...
export default {
  ...
  methods: {
    ...
    getList() {
      ...
      request({
        url: 'build/bQualConcreteMonitoring/list',
        method: 'post',
    ...
    handleUpdate(row) {
      ...
      request({
        url: 'build/bQualConcreteMonitoring/selectById/' + pipeId,
        method: 'get'
      }).then(response => {
      ...
      this.$refs['form'].validate(valid => {
        if (valid) {
          if (this.form.id != undefined) {
            request({
              url: 'build/bQualConcreteMonitoring/edit',
              method: 'post',
              data: this.form,
              headers: {
                'Content-Type': 'application/json;charset=UTF-8'
            ...
            request({
              url: 'build/bQualConcreteMonitoring/add',
              method: 'post',
              data: this.form,
              headers: {
                'Content-Type': 'application/json;charset=UTF-8'
    ...
    handleDelete(row) {
      ...
      this.$confirm('是否确认删除该数据项?', '警告', {
        ...
        return request({
          url: 'build/bQualConcreteMonitoring/deleteDetails/' + id,
          method: 'get'
        })
      }).then(() => {
        this.getList()
