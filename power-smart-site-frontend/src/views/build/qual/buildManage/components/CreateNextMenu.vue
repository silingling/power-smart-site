    ...
    <el-form
      ...
      label-width="100px">
        <el-form-item
          label="名称"
          prop="buildingName">
          <el-input v-model="menuForm.buildingName" />
        </el-form-item>
         <el-form-item
        label="类型"
        prop="treeNodeType"
...
export default {
  ...
  dictData(){
    ...
    if(this.menu.treeNodeType=='0'){
        this.dictList=[{'dictLabel':'层','dictValue':'1'}]
    }else if(this.menu.treeNodeType=='1'){
       this.dictList=[{'dictLabel':'户','dictValue':'2'},{'dictLabel':'楼层公区','dictValue':'3'}]
    }else if(this.menu.treeNodeType=='2'){
       this.dictList=[{'dictLabel':'房间','dictValue':'4'},{'dictLabel':'其他','dictValue':'5'}]
    }
  },
    saveRootMenu(){
