    ...
    <div class="dialog-body">
      ...
      <div
        ...
        <div class="content content-tips">
          <div>操作步骤：</div>
          <div>1、下载《质量问题导入模板》</div>
          <div>2、打开《质量问题导入模板》将对应字段信息输入或粘贴进本表。为保障粘贴信息被有效导入，请使用纯文本或数字</div>
...
import { excelImportAPI } from '../../api/question'
...
export default {
  ...
  /*    downloadFileAPI('/adminFile/down/123').then(res => {
      ...
      window.open("http://www.oceanus-health.com/hdwxsc/wx/jump/download2?id=145fd6b3d869460cab094591a02fa785")
    },
