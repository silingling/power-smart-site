<template>
  <el-dialog
    ...
    <el-form
      ...
      <el-row>
        <el-col :span="12">
            <el-form-item label="试题类型名称" prop="typeName">
              <el-input v-model="menuForm.typeName" />
            </el-form-item>
        </el-col>
        <el-col :span="12">
      ...
      <el-row>
        <el-col :span="12">
          <el-form-item label="编码" prop="typeCode">
            <el-input v-model="menuForm.typeCode"/>
          </el-form-item>  
        </el-col>
        <el-col :span="12">
          <el-form-item label="排序号" prop="typeNum">
            <el-input type="number" v-model="menuForm.typeNum" />
          </el-form-item>
        </el-col>
      ...
      <el-row>
        <el-col :span="12">
          <el-form-item label="试题描述" prop="typeDescribe">
            <el-input v-model="menuForm.typeDescribe" :row="2"
                      :maxlength="300"
                      type="textarea" />
          </el-form-item>
        </el-col>
  ...
  export default {
    ...
    data() {
      return {
        ...
        // 自定义字段信息表单
        menuForm: {
          parentId : this.action.parentId,
          pname: this.action.pname,
        },

      }
    },
    created(){
       this.menuForm.pname = this.action.pname
