...
<!--    </div>-->
    ...
    <el-form v-show="true" ref="queryForm" :model="queryParams" :inline="true" label-width="80px"
      ...
      <el-form-item label="监测项类型">
        <el-select v-model="queryParams.monitorSonType" clearable placeholder="请选择监测项类型">
          <el-option
...
<script>
  ...
  import {getListAllProject, delTrueByIds,getProjectsList} from "../api/monitorPoint"
  ...
  export default {
    ...
    methods: {
      ...
      getList() {
        ...
        getListAllProject(this.queryParams)
          .then(res => {
