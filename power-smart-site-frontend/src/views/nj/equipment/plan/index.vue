<template>
  <div class="main">
    ...
    <div class="main-body">
      <el-form class="searchFrom" v-show="showSearch" ref="queryForm" :model="queryParams" :inline="true" label-width="92px">
      ...
      <el-table v-loading="loading" :data="typeList" :height="tableHeight" highlight-current-row="">
        <el-table-column label="序号" type="index" show-overflow-tooltip width="70"></el-table-column>
        <el-table-column label="维护计划名称" prop="planName" width="250px"/>
        ...
        <el-table-column label="执行周期单位" prop="unit" :formatter="unitFormat" align="center"/>
        <el-table-column label="执行部门" prop="deptName" width="150px"/>
        <el-table-column label="是否启用" prop="enable" :formatter="enableFormat" align="center"/>
        <el-table-column label="下次执行日期" prop="nextDate" align="center" width="150px">
