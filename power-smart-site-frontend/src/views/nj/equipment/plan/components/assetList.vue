<template>
  <div class="main">
    <div class="main-body">
      ...
      <el-dialog title="选择设备资产" :visible.sync="open" width="80%" append-to-body
                 :show-close="false" class="abow_dialog">
        <asset-add @change="change" :checkedRows="tableData" :planId="planId" :key="addKey"></asset-add>
        <div slot="footer" class="dialog-footer">
          <el-button type="primary" @click="changeAsset">选择</el-button>
