    ...
    <div class="main">
        ...
        <div class="main-body">
            <el-form v-show="showSearch" ref="queryForm" :model="queryParams" :inline="true" label-width="80px" style="padding-top: 20px;padding-left:10px;">
                <el-form-item label="门禁点" prop="subcontractorId">
                    <el-select
                ...
                <el-form-item label="打卡日期" prop="teamLeaderName">
                    <el-date-picker
                            type="datetime"
                ...
                <el-form-item label="用户姓名" prop="teamLeaderName">
                    <el-input
            ...
            <el-table v-loading="loading" :data="dataList">
                ...
                <el-table-column label="打卡区域" align="center" prop="t1" width="250px"/>
<!--                <el-table-column label="扫码区域" align="center" prop="t2" width="120px"/>-->
                <el-table-column label="门禁点" align="center" prop="t3"/>
                <el-table-column label="打卡人" align="center" prop="t4" width="250px"/>
                <el-table-column label="联系电话" align="center" prop="t5"/>
                <el-table-column label="打卡时间" align="center" prop="t6"/>
                <el-table-column label="开门方式" align="center" prop="t7"/>
    ...
    export default {
        ...
        data() {
            return {
                ...
                // 表格数据
                dataList: [
                    {t1:"C座A栋",t2:"",t3:"1单元门禁点",t4:"姜镇",t5:"13061460757",t6:"2021-06-20 15:00",
                        t7:"打卡"},
                    {t1:"园区南大门",t2:"",t3:"人脸识别点#03",t4:"姜镇",t5:"13061460757",t6:"2021-06-20 14:00",
                        t7:"刷脸"},
                    {t1:"A座B栋",t2:"",t3:"2单元门禁点",t4:"姜镇",t5:"13061460757",t6:"2021-06-20 13:00",
                        t7:"打卡"}],
                // 弹出层表格数据
                dataList2: [],
                // 弹出层标题
