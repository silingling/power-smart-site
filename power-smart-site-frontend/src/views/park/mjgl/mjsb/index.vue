    ...
    <div class="main">
        ...
        <div class="main-body">
            <el-form v-show="showSearch" ref="queryForm" :model="queryParams" :inline="true" label-width="80px" style="padding-top: 20px;padding-left:10px;">
                <el-form-item label="设备类型" prop="subcontractorId">
                    <el-select
                ...
                <el-form-item label="设备编号" prop="teamLeaderName">
                    <el-input
                ...
                <el-form-item label="设备名称" prop="teamLeaderName">
                    <el-input
                            v-model="queryParams.teamLeaderName"
                            placeholder=""
                            clearable
            ...
            <el-table v-loading="loading" :data="dataList">
                ...
                <el-table-column label="设备编号" align="center" prop="t1" width="250px"/>
                <el-table-column label="设备名称" align="center" prop="t2" width="120px"/>
                <el-table-column label="门禁地点" align="center" prop="t3"/>
                <el-table-column label=设备类型 align="center" prop="t4" width="250px"/>
                <el-table-column label="序列号" align="center" prop="t5"/>
                <el-table-column label="状态" align="center" prop="t6"/>
                <el-table-column label="最后上线时间" align="center" prop="t7"/>
    ...
    export default {
        ...
        data() {
            return {
                ...
                // 表格数据
                dataList: [
                    {t1:"SB1622794255",t2:"东大门#01",t3:"园区东大门",
                        t4:"人脸识别机",t5:"SN1622769155",
                        t6:"在线",t7:"2021-06-20 14:55"},
                    {t1:"SB1622794257",t2:"南大门#03",t3:"园区南大门",
                        t4:"人脸识别机",t5:"SN1622769157",
                        t6:"在线",t7:"2021-06-20 14:55"}],
                // 弹出层表格数据
                dataList2: [],
                // 弹出层标题
