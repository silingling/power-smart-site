    ...
    <div class="main">
        ...
        <div class="main-body">
            <el-form v-show="showSearch" ref="queryForm" :model="queryParams" :inline="true" label-width="80px" style="padding-top: 20px;padding-left:10px;">
                <el-form-item label="扫码地点" prop="subcontractorId">
                    <el-select
                ...
                <el-form-item label="扫码日期" prop="teamLeaderName">
                    <el-date-picker
                            type="datetime"
                ...
                <el-form-item label="到访人" prop="teamLeaderName">
                    <el-input
            ...
            <el-table v-loading="loading" :data="dataList">
                ...
                <el-table-column label="扫码地点" align="center" prop="t1" width="250px"/>
<!--                <el-table-column label="扫码区域" align="center" prop="t2" width="120px"/>-->
                <el-table-column label="扫码时间" align="center" prop="t3"/>
                <el-table-column label="到访人" align="center" prop="t4" width="250px"/>
                <el-table-column label="到访预约时间" align="center" prop="t5"/>
                <el-table-column label="到访地点" align="center" prop="t6"/>
                <el-table-column label="到访事由" align="center" prop="t7"/>
    ...
    export default {
        ...
        data() {
            return {
                ...
                // 表格数据
                dataList: [
                    {t1:"C座A栋-2号电梯",t2:"",t3:"2021-06-20 15:33",t4:"姜镇",t5:"2021-06-20 15:00",
                        t6:"C座A栋3F-501",t7:"商务洽谈"},
                    {t1:"C座A栋-1号门",t2:"",t3:"2021-06-20 15:35",t4:"姜镇",t5:"2021-06-20 15:00",
                        t6:"C座A栋3F-501",t7:"商务洽谈"}],
                // 弹出层表格数据
                dataList2: [],
                // 弹出层标题
