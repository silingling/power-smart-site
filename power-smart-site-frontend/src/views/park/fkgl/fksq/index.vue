  ...
  <div class="main">
    ...
    <div class="main-body">
      <el-form v-show="showSearch" ref="queryForm" :model="queryParams" :inline="true" label-width="80px" style="padding-top: 20px;padding-left:10px;">
        <el-form-item label="访问地点" prop="subcontractorId">
          <el-select
        ...
        <el-form-item label="访客姓名" prop="teamLeaderName">
          <el-input
          ...
          <el-form-item label="到访日期" prop="teamLeaderName">
              <el-date-picker
                      type="datetime"
...
<!--          <el-table-column label="管理区" align="center" prop="t1" width="250px"/>-->
          <el-table-column label="访客人姓名" align="center" prop="t2" width="120px"/>
          <el-table-column label="联系电话" align="center" prop="t3"/>
          <el-table-column label="到访地址" align="center" prop="t4" width="250px"/>
          <el-table-column label="到访时间" align="center" prop="t5"/>
          <el-table-column label="被访人" align="center" prop="t6"/>
          <el-table-column label="事由" align="center" prop="t7"/>
          <el-table-column label="状态" align="center" prop="t8"/>
...
export default {
  ...
  data() {
    return {
      ...
      total2: 0,
      // 表格数据
      dataList: [{t1:"",t2:"张健",t3:"13064645717",t4:"C座A栋301",t5:"2021-06-22",
          t6:"李强",t7:"商务洽谈",t8:"未授权"},
          {t1:"",t2:"王军",t3:"13064643214",t4:"A座A栋601",t5:"2021-06-20",
              t6:"李强",t7:"寻求合作",t8:"已授权"}],
	  // 弹出层表格数据
	  dataList2: [],
      // 弹出层标题
      title: '',
