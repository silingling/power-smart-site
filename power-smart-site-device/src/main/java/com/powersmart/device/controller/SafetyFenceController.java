...
public class SafetyFenceController {
    ...
    /** 启用/禁用围栏 */
    @PostMapping("/setSafetyFenceEnabled")
    ...
    /** 查询某项目下所有启用的围栏 */
    @PostMapping("/getActiveFenceList")
    ...
    @PostMapping("/checkPointInFences")
