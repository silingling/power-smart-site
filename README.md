...
> **混合架构**: 自研 Spring Cloud 微服务后端 + 萤丰 YFConstruction 开源前端
...
| **文档** | Knife4j (Swagger) |
| **前端** | 对接萤丰 YFConstruction Vue/UniApp |
...
- [x] Phase 1: 后端骨架 + 萤丰前端 API 适配 (113文件/3742行)
- [ ] Phase 2: 网关路由 + 登录鉴权
- [ ] Phase 3: Fork 萤丰前端替换 API 层
- [ ] Phase 4: IoT 设备接入 + 告警引擎完善
- [ ] Phase 5: 电力行业专项 (变电站/输电/配电)

## 🔗 参考

- 萤丰 YFConstruction: https://gitee.com/qingyun-software/YFConstruction
